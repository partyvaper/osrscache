...
//ORIGINAL LINE: @Data public class ModelDefinition
	public class ModelDefinition
	{
		...
		/// texture.
		/// </summary>
		public virtual void computeTextureUVCoordinates()
		{
		...
		public virtual void computeAnimationTables()
		{
		...
		public virtual void rotate(int orientation)
		{
			int sin = CircularAngle.SINE[orientation];
			int cos = CircularAngle.COSINE[orientation];

			Debug.Assert(vertexPositionsX.Length == vertexPositionsY.Length);
			Debug.Assert(vertexPositionsY.Length == vertexPositionsZ.Length);
		...
		public virtual void resetAnim()
		{
			...
			Array.Copy(origVX, 0, vertexPositionsX, 0, origVX.Length);
			Array.Copy(origVY, 0, vertexPositionsY, 0, origVY.Length);
			Array.Copy(origVZ, 0, vertexPositionsZ, 0, origVZ.Length);
		}

		public virtual void animate(int type, int[] frameMap, int dx, int dy, int dz)
		{
			if (origVX == null)
			{
...
//ORIGINAL LINE: final int[] verticesX = vertexPositionsX;
			int[] verticesX = vertexPositionsX;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final int[] verticesY = vertexPositionsY;
			int[] verticesY = vertexPositionsY;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final int[] verticesZ = vertexPositionsZ;
			int[] verticesZ = vertexPositionsZ;
		...
		public virtual void method1493()
		{
			int var1;
			for (var1 = 0; var1 < this.vertexCount; ++var1)
			{
		...
		public virtual void resize(int var1, int var2, int var3)
		{
		...
		public virtual void recolor(short var1, short var2)
		{
		...
		public virtual void retexture(short var1, short var2)
		{
		...
		public virtual void move(int xOffset, int yOffset, int zOffset)
		{
		...
		public virtual void computeMaxPriority()
		{
