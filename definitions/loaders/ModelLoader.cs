namespace OSRSCache.definitions.loaders
{
	...
	public class ModelLoader
	{
		...
		private void load1(ModelDefinition model, byte[] var1)
		{
			...
			var2.Offset = colorPos;
			var24.Offset = renderTypePos;
			var3.Offset = priorityPos;
			var28.Offset = alphaPos;
			var6.Offset = triangleSkinPos;
			var55.Offset = texturePos;
			var51.Offset = textureCoordPos;
