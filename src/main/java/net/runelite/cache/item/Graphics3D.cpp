...
const double Graphics3D::UNIT = M_PI / 1024.0;
const std::vector<int> Graphics3D::SINE = std::vector<int>(2048);
const std::vector<int> Graphics3D::COSINE = std::vector<int>(2048);
std::vector<int> Graphics3D::field1932(512);
std::vector<int> Graphics3D::field1933(2048);

	Graphics3D::StaticConstructor::StaticConstructor()
	{
...
Graphics3D::StaticConstructor Graphics3D::staticConstructor;

	Graphics3D::Graphics3D(std::shared_ptr<RSTextureProvider> textureProvider) : textureProvider(textureProvider)
	{
	}

	void Graphics3D::setRasterClipping()
	{
		setRasterClipping(draw_region_x, drawingAreaTop, drawingAreaRight, drawingAreaBottom);
	}

	void Graphics3D::setRasterClipping(int var0, int var1, int var2, int var3)
	{
		rasterClipX = var2 - var0;
		Rasterizer3D_clipHeight = var3 - var1;
		Rasterizer3D_method3();

		if (rasterClipY.size() < Rasterizer3D_clipHeight)
		{
			// Find closest 2^n >= v
			int v = Rasterizer3D_clipHeight - 1;
			v |= static_cast<int>(static_cast<unsigned int>(v) >> 1);
			v |= static_cast<int>(static_cast<unsigned int>(v) >> 2);
			v |= static_cast<int>(static_cast<unsigned int>(v) >> 4);
			v |= static_cast<int>(static_cast<unsigned int>(v) >> 8);
			v |= static_cast<int>(static_cast<unsigned int>(v) >> 16);
			rasterClipY = std::vector<int>(v + 1);
		}
	...
	void Graphics3D::Rasterizer3D_method3()
	{
	...
	void Graphics3D::setOffset(int x, int y)
	{
	...
	void Graphics3D::setBrightness(double brightness)
	{
		colorPalette = JagexColor::createPalette(brightness);
	}

	void Graphics3D::rasterGouraud(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8)
	{
		int var9 = var4 - var3;
		int var10 = var1 - var0;
		int var11 = var5 - var3;
	...
	void Graphics3D::method2778(std::vector<int> &var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7)
	{
		if (rasterClipEnable)
		{
			if (var5 > rasterClipX)
	...
	void Graphics3D::rasterFlat(int var0, int var1, int var2, int var3, int var4, int var5, int var6)
	{
		int var7 = 0;
		if (var0 != var1)
		{
	...
	void Graphics3D::method2842(std::vector<int> &var0, int var1, int var2, int var3, int var4, int var5)
	{
		if (rasterClipEnable)
		{
			if (var5 > rasterClipX)
	...
	void Graphics3D::rasterTextureAffine(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17, int var18)
	{
		std::vector<int> var19 = textureProvider->load(var18);
		int var20;
		if (var19.empty())
		{
		...
		else
		{
			...
			if (var29 != 0)
			{
				...
				int var33 = static_cast<int>((static_cast<long long>(var15 * var14 - var17 * var12) << 3 << 14) / static_cast<long long>(Rasterizer3D_zoom));
				int var34 = static_cast<int>((static_cast<long long>(var17 * var9 - var11 * var15) << 14) / static_cast<long long>(Rasterizer3D_zoom));
				int var35 = var10 * var12 - var13 * var9 << 14;
				int var36 = static_cast<int>((static_cast<long long>(var13 * var15 - var16 * var12) << 3 << 14) / static_cast<long long>(Rasterizer3D_zoom));
				int var37 = static_cast<int>((static_cast<long long>(var16 * var9 - var10 * var15) << 14) / static_cast<long long>(Rasterizer3D_zoom));
				int var38 = var13 * var11 - var10 * var14 << 14;
				int var39 = static_cast<int>((static_cast<long long>(var16 * var14 - var13 * var17) << 3 << 14) / static_cast<long long>(Rasterizer3D_zoom));
				int var40 = static_cast<int>((static_cast<long long>(var17 * var10 - var11 * var16) << 14) / static_cast<long long>(Rasterizer3D_zoom));
				int var41;
				if (var0 <= var1 && var0 <= var2)
				{
					if (var0 < Rasterizer3D_clipHeight)
	...
	void Graphics3D::method2791(std::vector<int> &var0, std::vector<int> &var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14)
	{
		if (rasterClipEnable)
		{
			if (var6 > rasterClipX)
			...
			if (lowMem)
			{
				...
				if (field1909)
				{
					if (var17 > 0)
					{
						do
						{
							var3 = var1[(static_cast<int>(static_cast<unsigned int>(var2) >> 26)) + (var2 & 4032)];
				...
				else
				{
					if (var17 > 0)
					{
						do
						{
							if ((var3 = var1[(static_cast<int>(static_cast<unsigned int>(var2) >> 26)) + (var2 & 4032)]) != 0)
							{
								var0[var4] = (var15 * (var3 & 65280) & 16711680) + ((var3 & 16711935) * var15 & -16711936) >> 8;
							}
			...
			else
			{
				...
				if (field1909)
				{
					if (var17 > 0)
					{
						do
						{
							var3 = var1[(var2 & 16256) + (static_cast<int>(static_cast<unsigned int>(var2) >> 25))];
							var0[var4++] = (var15 * (var3 & 65280) & 16711680) + ((var3 & 16711935) * var15 & -16711936) >> 8;
							var2 += var16;
							var3 = var1[(var2 & 16256) + (static_cast<int>(static_cast<unsigned int>(var2) >> 25))];
							var0[var4++] = (var15 * (var3 & 65280) & 16711680) + ((var3 & 16711935) * var15 & -16711936) >> 8;
				...
				else
				{
					if (var17 > 0)
					{
						do
						{
							if ((var3 = var1[(var2 & 16256) + (static_cast<int>(static_cast<unsigned int>(var2) >> 25))]) != 0)
							{
								var0[var4] = (var15 * (var3 & 65280) & 16711680) + ((var3 & 16711935) * var15 & -16711936) >> 8;
							}
	...
	int Graphics3D::method2794(int var0, int var1)
	{
